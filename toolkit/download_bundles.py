...
Usage:
    python toolkit/download_bundles.py --list [--match SUBSTR]
    python toolkit/download_bundles.py --match SUBSTR [--match SUBSTR2]
    python toolkit/download_bundles.py --all
...
def ensure_catalog():
    ...
    if not os.path.exists(SRC_CATALOG):
        ...
        urllib.request.urlretrieve(common.CATALOG_URL, SRC_CATALOG)
