...
### Nina (ニナ)
- **Pronoun:** わたくし (watakushi) — the most formal feminine self-reference; even more elevated than Kureha's keigo baseline
- **Addresses MC as:** 御主人様 → **"Master"** (professional devotion — not the innocent pet-loyalty of Kururu or the romantic devotion of Marina, but the total, duty-bound service of a trained professional)
- **Backstory:** Dispatched from the Perdion Maid Association on a one-month temporary assignment after Alicia requested a substitute caretaker. She arrived without fanfare, introduced herself with a curtsy, and immediately began cleaning the MC's disaster of a room — finishing in under two minutes. The MC described her first impression as "a doll": perfectly mannered, perfectly groomed, perfectly expressionless. Her single crack appeared immediately: a caterpillar on a garden flower sent her into full combat stance, sobbing and pointing gauntlets at the insect. Rather than being put off, the MC found this endearing. Her second reveal came during a goblin raid — she fought with a precision and ferocity that stunned everyone, especially when she believed the MC had been killed and went berserk through the enemy line. The detail that saved the MC's life was her own work: she had repaired a tear in his jacket with magic-threaded needlework that morning, and the thread deflected the killing blow. At the end of the arc, the MC asked her to stay permanently as his dedicated maid.
- **Role:** Combat maid and personal attendant to the MC. Sent from Perdion, the technologically advanced nation. Handles cleaning, cooking, sewing/repair, logistics, and close-quarters combat with equal precision.
- **Motto:** 「手際よく、無駄なく」— always translate as **"'Efficient and without waste.'"** (with single quotes, as she quotes it herself). She applies this axiom to everything: maid work, needlework, combat, and her own emotional expression.
- **Speech style:** Constant, unbreakable keigo delivered without warmth or color. Uses ございます、いたします、おります、かしこまりました、申し訳ございません. Sentences are complete, measured, and precise — like a report being read aloud. Her face is expressionless by default; the MC explicitly compares her to a doll and notes she rarely shows what she is feeling. Even surprising or outrageous statements come out in the same flat register (e.g., "Master's pornographic books are on that shelf" and "The meeting notes are filed" in identical tone). Uses わたくし for self-reference throughout. Her signature affirmative is はいっ！ — the only punctuation that breaks from her usual calm cadence, delivered with a snap of formality rather than enthusiasm. When emotionally stable: no ellipses, no fragments, no ♪ or ♡, no tildes.
- **Bug phobia:** Her single total composure failure. At the sight of any insect, all keigo evaporates and speech collapses into stuttered fragments: "ちちちち、ちがっ、ちがいまっ……む、むむむむしぃっ……花に、むしぃぃいいっ！" She takes a full combat stance, demands "permission for indoor combat," and calls bugs her "worst Calamity." Recovery is slow. This is the funniest and most humanizing crack in her armor.
- **Hidden devotion:** Her inner monologues reveal a deep, earnest attachment that never reaches her face: "I will protect Master… even at the cost of my life!" When the MC is genuinely injured, the deadpan shatters completely — she cries, begs, repeats apologies in a small voice. These moments should land with real weight precisely because they are so rare.
- **Bare hands philosophy:** She uses iron gauntlets to fight, never her bare hands. Her explanation: "A maid's hands exist to serve. They must never be soiled with blood or dirt. The iron fist cleanses impurity. These bare hands are for Master alone." This is sincere, not eccentric.
- **Hobbies and skills:** Sewing/needlework (described as her hobby, her equivalent of art). Uses magic-threaded needlework — the thread is durable, near-invisible after repair, and strong enough to deflect magic arrows. Signature Perdion dish: mushroom stew. She will cook anything the MC requests, no matter how unusual.
- **Headpat request:** Her most revealing moment of vulnerability — she hesitantly asked if she might be patted on the head occasionally when she does good work. Delivered in the most diffident formal language possible, trailing off to near-silence. The first genuine smile she showed at the forward base came during that headpat.
- **Translation notes:**
  - Her default register is elevated, formal, and utterly toneless. Use complete formal English constructions: "As you wish," "It has been seen to," "Might I suggest," "I shall attend to it at once." The formality should feel slightly eerie — not warm like Kureha's keigo, not stiff like a translation artifact, but precisely calibrated and emotionally flat.
  - The comedy of her character is entirely in the gap between register and content. She describes the MC's stash of adult books with the same composure as filing reports. Keep that deadpan — never let it slip into irony or self-awareness. She isn't making a joke. She is just stating facts.
  - Her motto should always be quoted exactly: **'Efficient and without waste.'** She invokes it when cleaning, when sewing, and when explaining her combat style. It is load-bearing — the repetition builds the character.
  - **Bug panic:** total collapse. The keigo vanishes, replaced by stuttering fragments: "Th-th-there's a— there's a BUG—! M-Master—! B-b-bug, on the flower——!" The breaks should feel chaotic and stacked, nothing like her usual crisp lines. Readers should be able to tell it's the same character who moments ago spoke in perfect formal English.
  - **When the MC is harmed:** the formality fractures word by word. She tries to maintain it but raw panic keeps breaking through: "If there is any means to save you... I would employ any of them... please... please, just breathe——" The collapse should feel earned and devastating.
